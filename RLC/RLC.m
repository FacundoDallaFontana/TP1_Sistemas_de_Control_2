...
u(i)=U;
figure
subplot(3,1,1), plot(t,u), title('Entrada'),grid, ylabel('Amplitude'),xlabel('Time (seconds)');
subplot(3,1,2),lsim(sys1,sys2,sys3,u,t),title('Tension en R'),grid,legend('R=4,7K','R=5,6K','R=10K');
subplot(3,1,3), lsim(sys4,sys5,sys6,u,t),title('Tension en C'),grid,legend('R=4,7K','R=5,6K','R=10K');
